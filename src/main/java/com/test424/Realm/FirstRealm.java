//package com.test424.Realm;
//
//import com.aixs.crud.bean.User;
...
//        if (user != null) {
//            // 存在
//            AuthenticationInfo authcInfo = new SimpleAuthenticationInfo(user.getUsername(), user.getPassword(), "relam1");
//            return authcInfo;
//        }
//        // 不存在
//        return null;
